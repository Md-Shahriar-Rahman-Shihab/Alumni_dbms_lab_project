...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="http://localhost/alumni/index.php?page=home">CONNECT</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="http://localhost/alumni/admin/index.php?page=home">Dashboard</a></li>
          <?php if (!isset($_SESSION['login_id'])): ?>
  ...
  <footer class=" py-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
          ...
          <div class="text-white">+8801903006546</div>
        </div>
    ...
    <br>
    <div class="container">
      <div class="small text-center text-muted">Copyright © 2024 - <?php echo $_SESSION['system']['name'] ?> | <a href="http://localhost/alumni/index.php?page=home" target="_blank">Connect</a></div>
    </div>
  </footer>
